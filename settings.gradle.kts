dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            plugin("gradle-ktlint", "org.jlleitschuh.gradle.ktlint").version("12.1.2")
            ...
            library("kotlinx-coroutines-android", "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.10.1")
            ...
            library("androidx-lifecycle-viewmodel-compose", "androidx.lifecycle:lifecycle-viewmodel-compose:2.8.7")
            library("androidx-lifecycle-viewmodel-ktx", "androidx.lifecycle", "lifecycle-viewmodel-ktx").versionRef("androidxlifecycle")

            library("androidx-work-runtime", "androidx.work:work-runtime-ktx:2.10.0")

            library("google-android-material", "com.google.android.material:material:1.12.0")
            ...
            library("google-tink", "com.google.crypto.tink:tink-android:1.16.0")
            ...
            library("androidx-hilt-navigation-compose", "androidx.hilt:hilt-navigation-compose:1.2.0")
            ...
            library("androidx-navigation-compose", "androidx.navigation:navigation-compose:2.8.5")
            ...
            library("androidx-paging-compose", "androidx.paging:paging-compose:3.3.5")

            library("androidx-constraintlayout-compose", "androidx.constraintlayout:constraintlayout-compose:1.1.0")

            version("compose", "1.7.6")
            ...
            library("datastore", "androidx.datastore:datastore:1.1.1")

            library("gms-location", "com.google.android.gms:play-services-location:21.3.0")

            version("junit5", "5.11.4")
            library("junit5-androidGradlePlugin", "de.mannodermaus.gradle.plugins:android-junit5:1.11.2.0")
            ...
            library("androidx-test-ext-junit", "androidx.test.ext:junit:1.2.1")
            library("androidx-test-espresso-core", "androidx.test.espresso:espresso-core:3.6.1")
