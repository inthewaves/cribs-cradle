dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            plugin("gradle-ktlint", "org.jlleitschuh.gradle.ktlint").version("12.1.0")
            ...
            library("kotlinx-coroutines-android", "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.8.0")
            ...
            version("androidxlifecycle", "2.7.0")
            ...
            library("androidx-work-runtime", "androidx.work:work-runtime-ktx:2.9.0")

            library("google-android-material", "com.google.android.material:material:1.11.0")
            ...
            library("google-tink", "com.google.crypto.tink:tink-android:1.12.0")
            ...
            library("androidx-paging-compose", "androidx.paging:paging-compose:3.2.1")
            ...
            library("gms-location", "com.google.android.gms:play-services-location:21.2.0")

            version("junit5", "5.10.2")
            library("junit5-androidGradlePlugin", "de.mannodermaus.gradle.plugins:android-junit5:1.10.0.0")
