dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("desugar", "com.android.tools:desugar_jdk_libs:1.2.0")
            ...
            library("androidx-navigation-compose", "androidx.navigation:navigation-compose:2.5.1")
            ...
            library("junit5-androidGradlePlugin", "de.mannodermaus.gradle.plugins:android-junit5:1.8.2.1")
