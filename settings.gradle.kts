dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("androidx-navigation-compose", "androidx.navigation:navigation-compose:2.8.6")
            ...
            library("datastore", "androidx.datastore:datastore:1.1.2")

            library("gms-location", "com.google.android.gms:play-services-location:21.3.0")

            version("junit5", "5.11.4")
            library("junit5-androidGradlePlugin", "de.mannodermaus.gradle.plugins:android-junit5:1.11.3.0")
