dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            plugin("gradle-ktlint", "org.jlleitschuh.gradle.ktlint").version("12.1.1")
            ...
            version("androidxlifecycle", "2.8.6")
            ...
            library("androidx-lifecycle-viewmodel-compose", "androidx.lifecycle:lifecycle-viewmodel-compose:2.8.6")
            library("androidx-lifecycle-viewmodel-ktx", "androidx.lifecycle", "lifecycle-viewmodel-ktx").versionRef("androidxlifecycle")

            library("androidx-work-runtime", "androidx.work:work-runtime-ktx:2.9.1")
            ...
            library("androidx-navigation-compose", "androidx.navigation:navigation-compose:2.8.3")
