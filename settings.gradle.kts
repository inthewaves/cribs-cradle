dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("google-tink", "com.google.crypto.tink:tink-android:1.15.0")
            ...
            library("androidx-navigation-compose", "androidx.navigation:navigation-compose:2.8.4")
            ...
            library("androidx-paging-compose", "androidx.paging:paging-compose:3.3.4")
